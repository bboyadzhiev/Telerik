namespace Cars.Tests.JustMock.Mocks
{
    ...
    public class JustMockCarsRepository : CarRepositoryMock, ICarsRepositoryMock
    {
        protected override void ArrangeCarsRepositoryMock()
        {
            ...
            //Mock.Arrange(() => this.CarsData.Add(Arg.IsAny<Car>()));
            ...
            Mock.Arrange(() => this.CarsData.GetById(Arg.IsInRange(0, 40, RangeKind.Inclusive))).Returns(this.FakeCarCollection.First());

            Mock.Arrange(() => this.CarsData.GetById(Arg.IsInRange(100, 200, RangeKind.Inclusive))).Returns<Car>(null);
